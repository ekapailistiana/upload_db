...
(1, 'eka junia', 'jl trisula, arjowilangun', 'Perempuan', 'RPL'),
(2, 'tasya aulia', 'tlogorejo', 'Perempuan', 'TKJ'),
(3, 'viona', 'jatikerto', 'Perempuan', 'TEI'),
(4, 'yayak', 'ngajum', 'laki-laki', 'TKR'),
(5, 'richard', 'panggungrejo', 'laki-laki', 'TSM');
